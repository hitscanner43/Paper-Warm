...
function CharacterTweakData:_presets(tweak_data, ...)
	...
	local dmg_lin_mul_tbl = { 0.5, 0.5, 0.75, 1, 1.25, 1.5, 1.5, 1.5 }
	...
	local dmg_lin_mul = dmg_lin_mul_tbl[diff_i]
	...
	presets.weapon.default.is_shotgun_pump.FALLOFF = {
		{ dmg_mul = 6 * dmg_lin_mul, r = 0, acc = { 0.8, 1 }, recoil = { 0.75, 1 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 3 * dmg_lin_mul, r = 1000, acc = { 0.6, 0.8 }, recoil = { 1, 1.5 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 0.5 * dmg_lin_mul, r = 2000, acc = { 0.4, 0.6 }, recoil = { 1.5, 2 }, mode = { 1, 0, 0, 0 } }
	}
	...
	presets.weapon.default.is_shotgun_mag.FALLOFF = {
		{ dmg_mul = 4 * dmg_lin_mul, r = 0, acc = { 0.7, 0.9 }, recoil = { 0.5, 1 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 2 * dmg_lin_mul, r = 1000, acc = { 0.5, 0.7 }, recoil = { 0.75, 1.5 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 0.5 * dmg_lin_mul, r = 2000, acc = { 0.3, 0.5 }, recoil = { 1, 2 }, mode = { 1, 0, 0, 0 } }
	}
	...
	presets.weapon.default.is_double_barrel.FALLOFF = {
		{ dmg_mul = 8 * dmg_lin_mul, r = 0, acc = { 0.8, 1 }, recoil = { 0.5, 0.75 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 4 * dmg_lin_mul, r = 1000, acc = { 0.6, 0.8 }, recoil = { 0.75, 1 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 0.5 * dmg_lin_mul, r = 2000, acc = { 0.4, 0.6 }, recoil = { 1, 1.5 }, mode = { 1, 0, 0, 0 } }
	}
	...
	presets.weapon.default.is_sniper.FALLOFF = {
		{ dmg_mul = 10 * dmg_lin_mul, r = 0, acc = { 0, 0.5 }, recoil = { 2, 3 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 10 * dmg_lin_mul, r = 1000, acc = { 0.5, 1 }, recoil = { 2, 3 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 10 * dmg_lin_mul, r = 3000, acc = { 0.5, 1 }, recoil = { 2, 3 }, mode = { 1, 0, 0, 0 } }
	}
	...
	presets.weapon.default.is_dmr.FALLOFF = {
		{ dmg_mul = 4 * dmg_lin_mul, r = 0, acc = { 0, 0.5 }, recoil = { 1, 1.5 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 4 * dmg_lin_mul, r = 1000, acc = { 0.5, 1 }, recoil = { 1, 1.5 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 4 * dmg_lin_mul, r = 3000, acc = { 0.5, 1 }, recoil = { 1, 1.5 }, mode = { 1, 0, 0, 0 } }
	}
	...
	presets.weapon.fbi_swat = based_on(presets.weapon.default, {
		aim_delay = { 0, 0.75 },
		focus_delay = 0.4,
		melee_dmg = 8 * dmg_lin_mul,
		RELOAD_SPEED = 1.1
	})

	accuracy_multiplier(presets.weapon.fbi_swat, 1.05)
	damage_multiplier(presets.weapon.fbi_swat, 1.25)
	
	presets.weapon.city_swat = based_on(presets.weapon.default, {
		aim_delay = { 0, 0.5 },
		focus_delay = 0.2, 
		melee_dmg = 10 * dmg_lin_mul,
		RELOAD_SPEED = 1.2
	})

	accuracy_multiplier(presets.weapon.city_swat, 1.1)	
	...
	presets.weapon.marksman.is_dmr.FALLOFF = {
		...
		{ dmg_mul = 8 * special_dmg_mul, r = 3000, acc = { 0.5, 1 }, recoil = { 1, 1.5 }, mode = { 1, 0, 0, 0 } }
	}
...
Hooks:PostHook(CharacterTweakData, "init", "hits_init", function(self)
	...
	self.heavy_swat.hurt_severity = self.presets.hurt_severities.base
	...
	self.triad_boss_no_armor.weapon = self.presets.weapon.boss
...
function CharacterTweakData:_set_presets()
	...
	local boss_low = 100
	local boss_medium = 200
	local boss_high = 300

	self.chavez_boss.HEALTH_INIT = boss_low * health_mul
	self.mobster_boss.HEALTH_INIT = boss_low * health_mul	
	self.biker_boss.HEALTH_INIT = boss_medium * health_mul
	self.drug_lord_boss.HEALTH_INIT = boss_medium * health_mul
	self.hector_boss.HEALTH_INIT = boss_medium * health_mul
	self.triad_boss.HEALTH_INIT = boss_medium * health_mul
	self.deep_boss.HEALTH_INIT = boss_high * health_mul
