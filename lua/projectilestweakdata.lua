...
self.projectiles.frag_npc.unit = "units/payday2/weapons/wpn_npc_frag_grenade/wpn_npc_frag_grenade"
self.projectiles.frag_npc.unit_dummy = "units/payday2/weapons/wpn_npc_frag_grenade/wpn_npc_frag_grenade_husk"
self.projectiles.frag_npc.impact_detonation = true
...
self.projectiles.concussion_npc.impact_detonation = true
