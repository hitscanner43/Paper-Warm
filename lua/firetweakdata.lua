Hooks:PostHook(FireTweakData, "init", "hits_init", function (self)
	...
	local trigger_chance_incendiary = 0.25
	...
	self.dot_entries.fire.proj_molotov.dot_trigger_chance = trigger_chance_incendiary

	self.dot_entries.fire.proj_launcher_incendiary.dot_length = 4
	self.dot_entries.fire.proj_launcher_incendiary.dot_trigger_chance = trigger_chance_incendiary
	
	self.dot_entries.fire.proj_launcher_incendiary_arbiter.dot_length = 4
	self.dot_entries.fire.proj_launcher_incendiary_arbiter.dot_trigger_chance = trigger_chance_incendiary
