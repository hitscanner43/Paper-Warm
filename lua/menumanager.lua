--Holdout's difficulty is Hard (aka Very Hard)
Hooks:PostHook(MenuCallbackHandler, "accept_skirmish_contract", "hits_init", function(self)
...
function MenuCallbackHandler:max_progress()
	...
	managers.experience:set_current_rank(100) -- change this value if you want a different infamy
