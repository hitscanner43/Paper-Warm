...
Hooks:PostHook(CopActionShoot, "init", "hits_init", function (self)
	...
	self._glint_effect = self._weapon_unit:effect_spawner(Idstring("glint_scope")) or self._weapon_unit:effect_spawner(Idstring("sniper_glare"))
	self._glare_bitmap = self._weapon_unit:effect_spawner(Idstring("sniper_glare")) and managers.hud._fullscreen_workspace:panel():bitmap({
